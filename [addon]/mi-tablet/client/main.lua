...
-- ============================================
-- Gang/Territory System NUI Callbacks
-- ============================================

-- NUI Callback: Check if player can see gangs (has VPN)
RegisterNUICallback('canSeeGangs', function(data, cb)
    TMC.Functions.TriggerServerCallback('mi-tablet:server:canSeeGangs', function(canSee)
        cb(canSee)
    end)
end)

-- NUI Callback: Get gang info
RegisterNUICallback('getGangInfo', function(data, cb)
    TMC.Functions.TriggerServerCallback('mi-tablet:server:getGangInfo', function(gangInfo)
        cb(gangInfo)
    end)
end)

-- NUI Callback: Get gang territories
RegisterNUICallback('getGangTerritories', function(data, cb)
    TMC.Functions.TriggerServerCallback('mi-tablet:server:getGangTerritories', function(territories)
        cb(territories)
    end)
end)

-- NUI Callback: Get owned territory IDs for filtering
RegisterNUICallback('getOwnedTerritoryIds', function(data, cb)
    TMC.Functions.TriggerServerCallback('mi-tablet:server:getOwnedTerritoryIds', function(ownedIds)
        cb(ownedIds)
    end)
end)

-- NUI Callback: Get location info for territories
RegisterNUICallback('getLocationInfo', function(data, cb)
    TMC.Functions.TriggerServerCallback('mi-tablet:server:getLocationInfo', function(locationInfo)
        cb(locationInfo)
    end)
end)

-- NUI Callback: Attempt to claim territory
RegisterNUICallback('gangAttemptClaim', function(data, cb)
    TMC.Functions.TriggerServerCallback('mi-tablet:server:gangAttemptClaim', function(result)
        cb(result)
    end, data)
end)

-- NUI Callback: Attempt to contest territory
RegisterNUICallback('gangAttemptContest', function(data, cb)
    TMC.Functions.TriggerServerCallback('mi-tablet:server:gangAttemptContest', function(result)
        cb(result)
    end, data)
end)

-- NUI Callback: Upgrade territory
RegisterNUICallback('gangUpgradeTerritory', function(data, cb)
    TMC.Functions.TriggerServerCallback('mi-tablet:server:gangUpgradeTerritory', function(result)
        cb(result)
    end, data)
end)

-- NUI Callback: Relinquish territory
RegisterNUICallback('gangRelinquishZone', function(data, cb)
    TMC.Functions.TriggerServerCallback('mi-tablet:server:gangRelinquishZone', function(result)
        cb(result)
    end)
end)

-- NUI Callback: Get gang upkeep information
RegisterNUICallback('getGangUpkeep', function(data, cb)
    TMC.Functions.TriggerServerCallback('mi-tablet:server:getGangUpkeep', function(upkeepInfo)
        cb(upkeepInfo)
    end)
end)
...
-- ============================================
-- Casino App NUI Callbacks
-- ============================================

-- NUI Callback: Get casino data
RegisterNUICallback('getCasinoData', function(data, cb)
    TMC.Functions.TriggerServerCallback('mi-tablet:server:getCasinoData', function(result)
        cb(result)
    end)
end)

-- NUI Callback: Set podium vehicle
RegisterNUICallback('casino:setPodiumVehicle', function(data, cb)
    TMC.Functions.TriggerServerCallback('mi-tablet:server:casino:setPodiumVehicle', function(result)
        cb(result)
    end, data.vehicle)
end)

-- NUI Callback: Hire employee
RegisterNUICallback('casino:hireEmployee', function(data, cb)
    TMC.Functions.TriggerServerCallback('mi-tablet:server:casino:hireEmployee', function(result)
        cb(result)
    end, data.citizenid, data.grade)
end)

-- NUI Callback: Fire employee
RegisterNUICallback('casino:fireEmployee', function(data, cb)
    local callbackCalled = false
    
    -- Timeout safety - if no response in 10 seconds, return error
    SetTimeout(10000, function()
        if not callbackCalled then
            callbackCalled = true
            cb({success = false, message = 'Request timed out'})
            debugPrint('Fire employee callback timed out')
        end
    end)
    
    TMC.Functions.TriggerServerCallback('mi-tablet:server:casino:fireEmployee', function(result)
        if not callbackCalled then
            callbackCalled = true
...
-- NUI Callback: Withdraw from casino
RegisterNUICallback('casino:withdraw', function(data, cb)
    TMC.Functions.TriggerServerCallback('mi-tablet:server:casino:withdraw', function(result)
        cb(result)
    end, data.amount)
end)

-- NUI Callback: Deposit to casino
RegisterNUICallback('casino:deposit', function(data, cb)
    TMC.Functions.TriggerServerCallback('mi-tablet:server:casino:deposit', function(result)
        cb(result)
    end, data.amount)
end)
